...
const PsicologoPerfilPage = () => {
  ...
  const [perfil, setPerfil] = useState({
    ...
    horarios: ["Segunda: 14h - 18h", "Quarta: 10h - 12h", "Sexta: 09h - 15h"],
  });
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 p-8">
      ...
      <div className="bg-white p-10 rounded-2xl shadow-xl w-full max-w-4xl mb-10 border border-gray-100">
        ...
        <div className="flex space-x-6">
          ...
          <button
            onClick={() => navigate("/agenda")} // Redireciona para a página de agenda
          ...
          <div className="bg-white p-8 rounded-2xl w-full max-w-md">
            ...
            <form
              onSubmit={(e) => {
                ...
                const especializacao = e.target.especializacao.value; // Obtém o valor do campo "especialização"
                const descricao = e.target.descricao.value; // Obtém o valor do campo "descrição"
                handleSave({ ...perfil, nome, especializacao, descricao }); // Salva as alterações
              }}
            >
              <div className="mb-4">
              ...
              <div className="mb-4">
                ...
                <input
                  type="text"
                  name="especializacao"
                  defaultValue={perfil.especializacao} // Valor inicial do campo "especialização"
                  className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              <div className="mb-6">
                ...
                <textarea
                  name="descricao"
                  defaultValue={perfil.descricao} // Valor inicial do campo "descrição"
                  className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
